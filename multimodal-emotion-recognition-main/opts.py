...
def parse_opts():
    ...
    parser.add_argument('--learning_rate', default=0.006, type=float, help='Initial learning rate (divided by 10 while training by lr scheduler)')
    ...
    parser.add_argument('--n_epochs', default=3, type=int, help='Number of total epochs to run')
